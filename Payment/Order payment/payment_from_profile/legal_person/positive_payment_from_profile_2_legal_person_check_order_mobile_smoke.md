...
* Шаги:
1. На главной странице нажать бургер-меню
2. Нажать кнопку с Именем профиля
3. Нажать "История заказов" в футере страницы
4. Нажать "Перейти к заказу" у нужного заказа
...
| Дата | Время | Версия браузера Десктоп | Результат/Баг в Трелло Десктоп | Версия браузера и ОС Тач | Результат/Баг в Трелло Тач | Дата релиза | QA  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2023-08-02 | 10:41 | |   | Safari  |PASS | 16.06.23 | Мария |
| 2023-08-29 | 12:10 |  |   | Chrome 116.0.5845.92 Android 10 | PASS | 27.08.23 | Татьяна |
|  |  |  |  |  |  |  |  |
