...
* Шаги:
  ...
  1.Поля ФИО, номер телефона, электронная почта заполнены валидными данными, способ оплаты выбрать "Оплата на сайте" нажать на кнопку "Оформить заказ"
 

* Ожидаемый результат:

   Открывается шлюз Сбербанка
