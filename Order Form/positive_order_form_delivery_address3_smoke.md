...
* Шаги:
  ...
  1.В поле "Населенный пункт" внести "Нижегродская область"
 

* Ожидаемый результат:

   1.В выпадающем листе появляются все населенные пункты Нижегродской области с возможностью выбрать нужный
