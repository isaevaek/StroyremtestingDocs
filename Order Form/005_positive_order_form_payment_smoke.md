...
* Предусловие:
  ...
  8. Открыт шлюз Сбербанка
 

* Шаги:

  1.Все поля шлюза заполнены валидными данными, нажать на кнопку "Оплатить"
 

* Ожидаемый результат:

   Открывается окно с информацией об успешной оплате заказа, информация о самом заказе. На почту приходить подробная информация о пункте самовывоза и информацией о заказе.
