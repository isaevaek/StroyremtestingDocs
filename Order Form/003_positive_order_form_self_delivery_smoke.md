...
* Предусловие:
  ...
  6.Способ доставки выбран "Самовывоз"
 

* Шаги:

  1.Выбрать дату в календаре, способ оплаты "Другой способ оплаты", отметить в тикбоксе согласием на обработку личных данных (неизвестно это будет или нет) и нажать на кнопку "Продолжить"
 

* Ожидаемый результат:

   Открывается окно "Шаг 2" с полями для заноления информации Физ.лица
