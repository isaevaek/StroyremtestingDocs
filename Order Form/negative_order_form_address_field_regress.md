...
* Предусловие:
 ...
 4.В поле "Населенный пункт" внесен "Нижний Тагил"
 

* Шаги:

  1.В поле "Адрес" внести "улица Калинин"
  
  
* Ожидаемый результат:

   Если введенный адрес не совпадает ни с одним из населенных пунктов из выпадающего списка, то при клике вне данного поля,
  
  поле обводится красной рамкой и ниже под под рамкой выводится сообщение "Адреса в базе нет, укажите точку на карте"
