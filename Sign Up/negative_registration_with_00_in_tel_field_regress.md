...
* Ожидаемый результат: Поле "Номер телефона" в рамке красного цвета и надпись "Введите корректные данные"
...
* Тестовый сервер Chrome
  ...
  | Дата       | Время | Результат | Имя     | Баг № Trello |
  | ---------- | ----- | --------- | ------- | ------------ |
  | 2023-07-13 | 14:42 | FAIL      | Татьяна | https://trello.com/c/A1HN4ZbK|
