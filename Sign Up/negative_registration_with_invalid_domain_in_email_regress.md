...
Регистрация нового пользователя (юридическое лицо) с не верным доменом (без расширения ru и т.п.) в поле "Электронная почта"
...
4. В поле "электронная почта" ввести электронный адрес с доменом без расширения после точки (например, ivanovtest@gmail.)
