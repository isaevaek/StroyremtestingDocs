...
Регистрация нового пользователя (юридическое лицо) с кириллицей в поле "Электронная почта"
...
4. В поле "электронная почта" напечатать адрес, состоящий из символов кириллицы вметсо латинских (например, орзгрз@gmail.com)
