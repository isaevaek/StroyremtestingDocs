...
Регистрация нового пользователя (юридическое лицо) с точкой в имени эл адреса в поле "Электронная почта"
...
4. В поле "электронная почта" ввести электронный адрес с точкой в имени адреса (например, ivanov.test@gmail.com)

5. Заполнить остальные поля валидными данными

6. Нажать кнопку "Зарегистрироваться"
* Ожидаемый результат: Успешно проходит регистрация нового пользовтаеля. Открывается страница профиля.
