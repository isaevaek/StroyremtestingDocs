...
Регистрация нового пользователя (юридическое лицо) без символа @ в поле "Электронная почта"
...
4. В поле "электронная почта" не вводить символ @ (например, ivanovgmail.com)
