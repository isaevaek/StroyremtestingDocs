...
Регистрация нового пользователя (юридическое лицо) с двумя символами @ в поле "Электронная почта"
...
4. В поле "электронная почта" ввести два символа @ (например, ivanov@@gmail.com)
