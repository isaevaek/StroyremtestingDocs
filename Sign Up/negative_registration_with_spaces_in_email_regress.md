...
Регистрация нового пользователя (юридическое лицо) с вводом пробелов в поле "Электронная почта"
...
4. В поле "электронная почта" ввести пробелы в имя и домен (например, iva nov@gmail.co m)
