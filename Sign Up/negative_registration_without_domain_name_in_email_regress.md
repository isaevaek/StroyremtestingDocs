...
Регистрация нового пользователя (юридическое лицо) без домена в поле "Электронная почта"
...
4. В поле "электронная почта" ввести электронный адрес без доменной части (например, ivanov@)
