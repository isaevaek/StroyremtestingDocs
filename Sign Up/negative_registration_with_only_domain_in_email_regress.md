...
Регистрация нового пользователя (юридическое лицо) без имени в поле "Электронная почта"
...
4. В поле "электронная почта" ввести электронный адрес без имени (например, @gmail.com)
